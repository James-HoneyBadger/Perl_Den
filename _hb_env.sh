#!/usr/bin/env bash
# ============================================================================
# _hb_env.sh - Project environment bootstrap (root copy)
#
# Sourced by the top-level launcher scripts (hb_perl, hb_cli, hb_tui,
# hb_gui).  Sets PATH, PERL5LIB, and share-directory variables, and
