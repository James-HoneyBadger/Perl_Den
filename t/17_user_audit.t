#!/usr/bin/env perl
# ============================================================================
# t/17_user_audit.t — Test PerlDen::Scripts::UserAudit
# ============================================================================
use strict;
use warnings;
use Test::More;
...
subtest 'format_report produces text' => sub {
    my $result = PerlDen::Scripts::UserAudit::run();
    my $report = PerlDen::Scripts::UserAudit::format_report($result);
