#!/usr/bin/env perl
# ============================================================================
# t/16_log_analyzer.t — Test PerlDen::Scripts::LogAnalyzer
# ============================================================================
use strict;
use warnings;
use Test::More;
...
use_ok('PerlDen::Scripts::LogAnalyzer');
...
LOG
    ...
    my $result = PerlDen::Scripts::LogAnalyzer::run(
        log_file  => $tmpfile,
        max_lines => 100,
    );
...
subtest 'format_report produces text' => sub {
    ...
    my $result = PerlDen::Scripts::LogAnalyzer::run(log_file => $tmpfile);
    my $report = PerlDen::Scripts::LogAnalyzer::format_report($result);
...
subtest 'format_report handles error' => sub {
    my $report = PerlDen::Scripts::LogAnalyzer::format_report({ error => 'test error' });
