...
subtest 'service map covers well-known ports' => sub {
    my $map = HBPerl::Scripts::PortScanner::_service_map();
...
subtest 'format_report for listen mode' => sub {
    my $result = HBPerl::Scripts::PortScanner::run(mode => 'listen');
    my $report = HBPerl::Scripts::PortScanner::format_report($result);
