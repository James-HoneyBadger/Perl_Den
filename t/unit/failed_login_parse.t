...
subtest 'parse SSH failed password' => sub {
    ...
    my @entries = PerlDen::Scripts::FailedLoginDetector::_parse_auth_lines(\@lines);
...
subtest 'syslog_to_epoch parses syslog format' => sub {
    my $epoch = PerlDen::Scripts::FailedLoginDetector::_syslog_to_epoch('Mar 15 10:22:33');
...
subtest 'syslog_to_epoch parses journalctl format' => sub {
    my $epoch = PerlDen::Scripts::FailedLoginDetector::_syslog_to_epoch('Mon 2026-03-15 14:30:00');
    ok(defined $epoch, 'returns a defined value');
    ok($epoch > 0, 'returns positive epoch');
...
subtest 'syslog_to_epoch handles unknown' => sub {
    my $epoch = PerlDen::Scripts::FailedLoginDetector::_syslog_to_epoch('unknown');
    ok(!defined $epoch, 'returns undef for unknown');
};

subtest 'syslog_to_epoch handles undef' => sub {
    my $epoch = PerlDen::Scripts::FailedLoginDetector::_syslog_to_epoch(undef);
...
subtest 'extract_time syslog format' => sub {
    my $t = PerlDen::Scripts::FailedLoginDetector::_extract_time(
...
subtest 'extract_time unrecognized' => sub {
    my $t = PerlDen::Scripts::FailedLoginDetector::_extract_time('garbage line');
...
subtest 'format_report handles empty results' => sub {
    ...
    my $report = PerlDen::Scripts::FailedLoginDetector::format_report($result);
