#!/usr/bin/env perl
# ============================================================================
# t/03_system_info.t — Test BadgerOps::Scripts::SystemInfo
# ============================================================================
use strict;
use warnings;
use Test::More;
...
use_ok('BadgerOps::Scripts::SystemInfo');
...
subtest 'hostname is non-empty' => sub {
    my $r = BadgerOps::Scripts::SystemInfo::run();
...
subtest 'format_report produces text' => sub {
    my $r = BadgerOps::Scripts::SystemInfo::run();
    my $report = BadgerOps::Scripts::SystemInfo::format_report($r);
