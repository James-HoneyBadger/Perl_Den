package HBPerl::Scripts::PortScanner;
# ============================================================================
...
HBPerl::Scripts::PortScanner - Port scanning and connection analysis

=head1 SYNOPSIS

    use HBPerl::Scripts::PortScanner;
    my $r = HBPerl::Scripts::PortScanner::run(
        host       => '127.0.0.1',
        port_range => '1-1024',
        timeout    => 1,
        mode       => 'scan',
    );
    print HBPerl::Scripts::PortScanner::format_report($r);
