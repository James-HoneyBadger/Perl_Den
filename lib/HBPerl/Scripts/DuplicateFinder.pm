package HBPerl::Scripts::DuplicateFinder;
# ============================================================================
...
HBPerl::Scripts::DuplicateFinder - Find duplicate files by content hash

=head1 SYNOPSIS

    use HBPerl::Scripts::DuplicateFinder;
    my $r = HBPerl::Scripts::DuplicateFinder::run(
        directory => '/home/james',
        min_size  => 1024,
        max_depth => 5,
    );
    print HBPerl::Scripts::DuplicateFinder::format_report($r);
