package HBPerl::Scripts::ProcessManager;
# ============================================================================
...
HBPerl::Scripts::ProcessManager - Process listing and analysis

=head1 SYNOPSIS

    use HBPerl::Scripts::ProcessManager;
    my $r = HBPerl::Scripts::ProcessManager::run(
        sort_by => 'cpu',
        top_n   => 20,
        filter  => 'perl',
    );
    print HBPerl::Scripts::ProcessManager::format_report($r);
