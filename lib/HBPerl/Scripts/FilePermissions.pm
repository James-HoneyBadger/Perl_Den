package HBPerl::Scripts::FilePermissions;
# ============================================================================
...
HBPerl::Scripts::FilePermissions - File permission security auditing

=head1 SYNOPSIS

    use HBPerl::Scripts::FilePermissions;
    my $r = HBPerl::Scripts::FilePermissions::run(
        target    => '/usr/local/bin',
        max_files => 10_000,
    );
    print HBPerl::Scripts::FilePermissions::format_report($r);
