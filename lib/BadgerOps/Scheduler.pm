package BadgerOps::Scheduler;
# ============================================================================
# BadgerOps::Scheduler - Schedule BadgerOps scripts via crontab (v2.0)
# ============================================================================
use strict;
use warnings;
...
# Sentinel comment that marks an BadgerOps cron entry
...
BadgerOps::Scheduler - Crontab-based job scheduler for BadgerOps scripts

=head1 SYNOPSIS

    use BadgerOps::Scheduler;
    ...
    BadgerOps::Scheduler::remove_job('system_info');

=head1 FUNCTIONS

=head2 add_job(%args)

Add a crontab entry for a BadgerOps script.
...
Return a list of hashrefs, each describing a scheduled BadgerOps job:
...
sub _hbperl_cli_path {
    ...
    require FindBin;
    FindBin->import;
    my $cli = "$FindBin::RealBin/badgerops-cli";
    return -f $cli ? $cli : 'badgerops-cli';
}
