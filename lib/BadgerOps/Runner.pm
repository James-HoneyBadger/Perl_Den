package BadgerOps::Runner;
# ============================================================================
# BadgerOps::Runner - Script execution engine with STDOUT/STDERR capture
# ============================================================================
use strict;
use warnings;
use utf8;
...
BadgerOps::Runner - Non-blocking script execution with output capture
...
=head1 SYNOPSIS
    ...
    # Sync (CLI / tests)
    my ($stdout, $stderr, $exit) = BadgerOps::Runner->run_sync('ls -la');
