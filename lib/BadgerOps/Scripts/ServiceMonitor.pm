package BadgerOps::Scripts::ServiceMonitor;
# ============================================================================
...
BadgerOps::Scripts::ServiceMonitor - Systemd service monitoring and status

=head1 SYNOPSIS

    use BadgerOps::Scripts::ServiceMonitor;
    my $r = BadgerOps::Scripts::ServiceMonitor::run(filter => 'ssh');
    print BadgerOps::Scripts::ServiceMonitor::format_report($r);
