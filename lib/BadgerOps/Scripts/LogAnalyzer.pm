package BadgerOps::Scripts::LogAnalyzer;
# ============================================================================
...
BadgerOps::Scripts::LogAnalyzer - System log parsing and analysis

=head1 SYNOPSIS

    use BadgerOps::Scripts::LogAnalyzer;
    my $r = BadgerOps::Scripts::LogAnalyzer::run(
        log_file  => '/var/log/syslog',
        max_lines => 5000,
        pattern   => 'error|fail',
    );
    print BadgerOps::Scripts::LogAnalyzer::format_report($r);
