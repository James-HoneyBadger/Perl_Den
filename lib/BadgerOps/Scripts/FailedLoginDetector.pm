package BadgerOps::Scripts::FailedLoginDetector;
# ============================================================================
...
BadgerOps::Scripts::FailedLoginDetector - Detect brute-force login attempts

=head1 SYNOPSIS

    use BadgerOps::Scripts::FailedLoginDetector;
    my $r = BadgerOps::Scripts::FailedLoginDetector::run(
        threshold => 5,
        hours     => 24,
        source    => '/var/log/auth.log',
    );
    print BadgerOps::Scripts::FailedLoginDetector::format_report($r);
