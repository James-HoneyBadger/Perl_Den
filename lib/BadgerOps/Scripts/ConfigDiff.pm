package BadgerOps::Scripts::ConfigDiff;
# ============================================================================
...
sub run {
    ...
    my $base_dir = $args{base_dir} // "$ENV{HOME}/.config/badgerops/baselines";
...
BadgerOps::Scripts::ConfigDiff - Track changes in system configuration files
...
=head1 SYNOPSIS
    ...
    print BadgerOps::Scripts::ConfigDiff::format_report($r);
