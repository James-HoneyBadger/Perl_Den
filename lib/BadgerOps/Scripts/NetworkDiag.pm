package BadgerOps::Scripts::NetworkDiag;
# ============================================================================
...
BadgerOps::Scripts::NetworkDiag - Network diagnostics and analysis

=head1 SYNOPSIS

    use BadgerOps::Scripts::NetworkDiag;
    my $r = BadgerOps::Scripts::NetworkDiag::run(
        dns_host  => 'example.com',
        ping_host => '8.8.8.8',
    );
    print BadgerOps::Scripts::NetworkDiag::format_report($r);
