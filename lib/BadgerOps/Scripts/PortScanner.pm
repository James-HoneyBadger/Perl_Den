package BadgerOps::Scripts::PortScanner;
# ============================================================================
...
BadgerOps::Scripts::PortScanner - Port scanning and connection analysis

=head1 SYNOPSIS

    use BadgerOps::Scripts::PortScanner;
    my $r = BadgerOps::Scripts::PortScanner::run(
        host       => '127.0.0.1',
        port_range => '1-1024',
        timeout    => 1,
        mode       => 'scan',
    );
    print BadgerOps::Scripts::PortScanner::format_report($r);
