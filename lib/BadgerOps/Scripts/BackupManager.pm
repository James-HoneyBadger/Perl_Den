package BadgerOps::Scripts::BackupManager;
# ============================================================================
...
BadgerOps::Scripts::BackupManager - Backup creation, verification and rotation
...
=head1 SYNOPSIS
    ...
    print BadgerOps::Scripts::BackupManager::format_report($r);
