package BadgerOps::Scripts::SSLChecker;
# ============================================================================
...
BadgerOps::Scripts::SSLChecker - SSL/TLS certificate expiry and analysis

=head1 SYNOPSIS

    use BadgerOps::Scripts::SSLChecker;
    my $r = BadgerOps::Scripts::SSLChecker::run(
        hosts   => ['example.com', 'github.com'],
        port    => 443,
        timeout => 5,
    );
    print BadgerOps::Scripts::SSLChecker::format_report($r);
