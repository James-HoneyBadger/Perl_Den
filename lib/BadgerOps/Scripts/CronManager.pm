package BadgerOps::Scripts::CronManager;
# ============================================================================
...
BadgerOps::Scripts::CronManager - Cron job listing and analysis

=head1 SYNOPSIS

    use BadgerOps::Scripts::CronManager;
    my $r = BadgerOps::Scripts::CronManager::run(user => 'root');
    print BadgerOps::Scripts::CronManager::format_report($r);
