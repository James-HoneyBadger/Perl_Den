package BadgerOps::Scripts::UserAudit;
# ============================================================================
...
BadgerOps::Scripts::UserAudit - User account security auditing

=head1 SYNOPSIS

    use BadgerOps::Scripts::UserAudit;
    my $r = BadgerOps::Scripts::UserAudit::run();
    print BadgerOps::Scripts::UserAudit::format_report($r);
