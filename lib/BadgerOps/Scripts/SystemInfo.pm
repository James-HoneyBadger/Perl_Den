package BadgerOps::Scripts::SystemInfo;
# ============================================================================
...
BadgerOps::Scripts::SystemInfo - Comprehensive Linux system information collector

=head1 SYNOPSIS

    use BadgerOps::Scripts::SystemInfo;
    my $info = BadgerOps::Scripts::SystemInfo::run();
    print BadgerOps::Scripts::SystemInfo::format_report($info);
