package BadgerOps::Git;
# ============================================================================
# BadgerOps::Git - Lightweight git integration for status bar and file browser
# ============================================================================
use strict;
use warnings;
...
BadgerOps::Git - Lightweight git status integration

=head1 SYNOPSIS

    use BadgerOps::Git;

    if (BadgerOps::Git::is_git_repo('/path/to/project')) {
        my $branch = BadgerOps::Git::current_branch('/path/to/project');
        my $summary = BadgerOps::Git::status_summary('/path/to/project');
        # "main | 3M 1?"
    }
