package BadgerOps::GUI::Dashboard;
# ============================================================================
# BadgerOps::GUI::Dashboard - Real-time system overview dashboard
# ============================================================================
use strict;
use warnings;
use utf8;
...
sub new {
    ...
    my $interval_secs = BadgerOps::Config::get('dashboard_refresh_seconds') // 5;
