package BadgerOps::GUI::ScriptBrowser;
# ============================================================================
# BadgerOps::GUI::ScriptBrowser - Tree view of sysadmin script categories
# ============================================================================
use strict;
use warnings;
use utf8;
...
use BadgerOps::ScriptRegistry qw(script_categories);
...
BadgerOps::GUI::ScriptBrowser - Sidebar tree view of sysadmin scripts

=head1 DESCRIPTION

Displays the 15 toolkit scripts in a categorised tree view populated
from L<BadgerOps::ScriptRegistry>.  Double-click opens a script in the
