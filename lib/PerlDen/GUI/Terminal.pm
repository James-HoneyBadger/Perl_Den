package PerlDen::GUI::Terminal;
# ============================================================================
# PerlDen::GUI::Terminal - Embedded VTE terminal and output panel
# ============================================================================
use strict;
use warnings;
use utf8;
...
sub _build_ui {
    ...
    my $cfg_font = PerlDen::Config::get('font') // 'monospace 11';
...
sub _run_in_output {
    ...
    $self->{runner} = PerlDen::Runner->new(
        on_stdout => sub {
            my ($text) = @_;
...
sub export_output {
    ...
    $dialog->set_current_name('perlden_output.txt');
...
PerlDen::GUI::Terminal - Embedded VTE terminal and script output panel
