package PerlDen::App;
# ============================================================================
# PerlDen::App - Main application controller
# ============================================================================
use strict;
use warnings;
use utf8;
...
use PerlDen::Config;
use PerlDen::Util qw(find_share_dir);
use PerlDen::GUI::MainWindow;
use Try::Tiny;
...
sub run {
    ...
    my $main_window = PerlDen::GUI::MainWindow->new(
        app       => $self,
...
sub apply_theme {
    my ($self) = @_;
    my $theme = PerlDen::Config::get('theme') // 'vscode-dark-plus';
    my %theme_css = (
...
PerlDen::App - Main application controller for Perl Den IDE
...
top-level coordinator between L<PerlDen::Config>, L<PerlDen::GUI::MainWindow>,
...
L<PerlDen::Config>, L<PerlDen::GUI::MainWindow>
