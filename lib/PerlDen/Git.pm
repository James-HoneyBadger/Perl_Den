package PerlDen::Git;
# ============================================================================
# PerlDen::Git - Lightweight git integration for status bar and file browser
# ============================================================================
use strict;
use warnings;
...
PerlDen::Git - Lightweight git status integration

=head1 SYNOPSIS

    use PerlDen::Git;

    if (PerlDen::Git::is_git_repo('/path/to/project')) {
        my $branch = PerlDen::Git::current_branch('/path/to/project');
        my $summary = PerlDen::Git::status_summary('/path/to/project');
        # "main | 3M 1?"
    }
