package PerlDen::Scripts::DuplicateFinder;
# ============================================================================
...
PerlDen::Scripts::DuplicateFinder - Find duplicate files by content hash

=head1 SYNOPSIS

    use PerlDen::Scripts::DuplicateFinder;
    my $r = PerlDen::Scripts::DuplicateFinder::run(
        directory => '/home/james',
        min_size  => 1024,
        max_depth => 5,
    );
    print PerlDen::Scripts::DuplicateFinder::format_report($r);
