package PerlDen::Scripts::DiskUsage;
# ============================================================================
...
# _fmt_size is provided by PerlDen::Util::format_bytes
...
PerlDen::Scripts::DiskUsage - Recursive directory size analysis

=head1 SYNOPSIS

    use PerlDen::Scripts::DiskUsage;
    ...
    print PerlDen::Scripts::DiskUsage::format_report($result);
