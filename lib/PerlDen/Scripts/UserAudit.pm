package PerlDen::Scripts::UserAudit;
# ============================================================================
...
PerlDen::Scripts::UserAudit - User account security auditing

=head1 SYNOPSIS

    use PerlDen::Scripts::UserAudit;
    my $r = PerlDen::Scripts::UserAudit::run();
    print PerlDen::Scripts::UserAudit::format_report($r);
