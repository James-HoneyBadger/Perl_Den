package PerlDen::Scripts::BackupManager;
# ============================================================================
...
PerlDen::Scripts::BackupManager - Backup creation, verification and rotation
...
=head1 SYNOPSIS
    ...
    print PerlDen::Scripts::BackupManager::format_report($r);
