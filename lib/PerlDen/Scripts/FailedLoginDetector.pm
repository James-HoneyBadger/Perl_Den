package PerlDen::Scripts::FailedLoginDetector;
# ============================================================================
...
PerlDen::Scripts::FailedLoginDetector - Detect brute-force login attempts

=head1 SYNOPSIS

    use PerlDen::Scripts::FailedLoginDetector;
    my $r = PerlDen::Scripts::FailedLoginDetector::run(
        threshold => 5,
        hours     => 24,
        source    => '/var/log/auth.log',
    );
    print PerlDen::Scripts::FailedLoginDetector::format_report($r);
