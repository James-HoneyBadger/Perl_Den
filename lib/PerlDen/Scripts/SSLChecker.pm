package PerlDen::Scripts::SSLChecker;
# ============================================================================
...
PerlDen::Scripts::SSLChecker - SSL/TLS certificate expiry and analysis

=head1 SYNOPSIS

    use PerlDen::Scripts::SSLChecker;
    my $r = PerlDen::Scripts::SSLChecker::run(
        hosts   => ['example.com', 'github.com'],
        port    => 443,
        timeout => 5,
    );
    print PerlDen::Scripts::SSLChecker::format_report($r);
