package PerlDen::Scripts::LogAnalyzer;
# ============================================================================
...
PerlDen::Scripts::LogAnalyzer - System log parsing and analysis

=head1 SYNOPSIS

    use PerlDen::Scripts::LogAnalyzer;
    my $r = PerlDen::Scripts::LogAnalyzer::run(
        log_file  => '/var/log/syslog',
        max_lines => 5000,
        pattern   => 'error|fail',
    );
    print PerlDen::Scripts::LogAnalyzer::format_report($r);
