package PerlDen::Scripts::CronManager;
# ============================================================================
...
PerlDen::Scripts::CronManager - Cron job listing and analysis

=head1 SYNOPSIS

    use PerlDen::Scripts::CronManager;
    my $r = PerlDen::Scripts::CronManager::run(user => 'root');
    print PerlDen::Scripts::CronManager::format_report($r);
