package PerlDen::Scripts::ProcessManager;
# ============================================================================
...
PerlDen::Scripts::ProcessManager - Process listing and analysis

=head1 SYNOPSIS

    use PerlDen::Scripts::ProcessManager;
    my $r = PerlDen::Scripts::ProcessManager::run(
        sort_by => 'cpu',
        top_n   => 20,
        filter  => 'perl',
    );
    print PerlDen::Scripts::ProcessManager::format_report($r);
