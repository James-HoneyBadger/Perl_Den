package PerlDen::Scripts::FilePermissions;
# ============================================================================
...
PerlDen::Scripts::FilePermissions - File permission security auditing

=head1 SYNOPSIS

    use PerlDen::Scripts::FilePermissions;
    my $r = PerlDen::Scripts::FilePermissions::run(
        target    => '/usr/local/bin',
        max_files => 10_000,
    );
    print PerlDen::Scripts::FilePermissions::format_report($r);
